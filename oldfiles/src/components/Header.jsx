        ...
        {isMenuOpen && (
          <div className="md:hidden border-t border-gray-200 py-4">
            <nav className="flex flex-col space-y-3">
              <Link to="/" className="text-gray-700 hover:text-blue-600 font-medium transition-colors py-2">
                Anasayfa
              </Link>
              <Link to="/hakkimizda" className="text-gray-700 hover:text-blue-600 font-medium transition-colors py-2">
                Hakkımızda
              </Link>
              <Link to="/yonetimkurulu" className="text-gray-700 hover:text-blue-600 font-medium transition-colors py-2">
                Yönetim Kurulu
              </Link>
              <Link to="/iletisim" className="text-gray-700 hover:text-blue-600 font-medium transition-colors py-2">
                İletişim
              </Link>
            </nav>
          </div>
